...
<div class="ai-pattern" style="padding: 2rem; border-radius: 12px; margin-bottom: 2rem;">
  <div class="section-header">
    <h1 class="gradient-text">Curriculum Vitae</h1>
    <p style="font-size: 1.1rem; color: #6b7280; margin-top: 0.5rem;">Professional experience, education, and achievements in AI/ML and plasma physics research</p>
  </div>
</div>

<div class="card animate-card" style="margin-bottom: 2rem;">
  <div class="card-header">
    <h3><i class="fas fa-user-graduate"></i> Education and Professional Experience</h3>
  </div>
  <div class="card-body">
    <ul class="list-modern">
      <li><strong>01/2021 – present:</strong> Research Scientist, <a href="https://newmexicoconsortium.org/" class="focus-modern">New Mexico Consortium</a>, Los Alamos, NM</li>
      <li><strong>01/2019 – 01/2021:</strong> Postdoc, <a href="https://www.lanl.gov/org/ddste/aldsc/theoretical/applied-mathematics-plasma-physics/index.php" class="focus-modern">Los Alamos National Lab</a>, Los Alamos, NM</li>
      <li><strong>02/2015 – 08/2018:</strong> Postdoc, <a href="https://silis.phys.strath.ac.uk/index.htm" class="focus-modern">University of Strathclyde</a>, Glasgow, UK</li>
      <li><strong>09/2009 - 03/2015:</strong> Ph.D. in Plasma Physics, <a href="https://llp.sjtu.edu.cn/" class="focus-modern">Shanghai Jiao Tong University</a>, Shanghai, China</li>
      <li><strong>09/2005 - 06/2009:</strong> B.S. in Applied Physics, Central South University, Changsha, China</li>
    </ul>
  </div>
</div>
...
<div class="card animate-card" style="margin-bottom: 2rem;">
  ...
  <div class="card-body">
    <ul class="list-modern">
      <li>
        <strong>PI:</strong> <a href="https://pamspublic.science.energy.gov/WebPAMSExternal/Interface/Common/ViewPublicAbstract.aspx?rv=c0307357-7dd7-45f0-8366-e9cf2dc10b76&rtc=24&PRoleId=10" class="focus-modern">The role of kinetic electrons in Alfven wave parametric instabilities at low plasma beta</a>, 2024-2027, DOE
        <span class="badge badge-ai">DOE</span>
      </li>
      <li>
        <strong>PI:</strong> <a href="https://pamspublic.science.energy.gov/WebPAMSExternal/Interface/Common/ViewPublicAbstract.aspx?rv=e5fd67b0-f5f4-4123-abf1-a0a6c267c479&rtc=24&PRoleId=10" class="focus-modern">Steps toward direct observation of the Alfvén wave parametric decay instability in a laboratory plasma</a>, 2023-2026, DOE
        <span class="badge badge-ai">DOE</span>
      </li>
      <li>
        <strong>PI:</strong> <a href="https://hesto.smce.nasa.gov/portfolio/" class="focus-modern">Scaling studies of seeded Alfvén wave parametric decay instability in the laboratory</a>, 2023-2026, NASA
        <span class="badge badge-ml">NASA</span>
      </li>
    </ul>
...
<div class="card animate-card" style="margin-bottom: 2rem;">
  <div class="card-header">
    <h3><i class="fas fa-trophy"></i> Selected Awards</h3>
  </div>
  <div class="card-body">
    <ul class="list-modern">
      <li><strong>2015:</strong> <a href="http://www.zpyf.org.cn/zzjl/csddlzwlj/54.html" class="focus-modern">Tsai Shih‑Tung Plasma Physics Award</a>, <em>by Chou Pei-yuan Foundation</em></li>
...
<div class="card animate-card" style="text-align: center; background: linear-gradient(135deg, rgba(139, 92, 246, 0.05) 0%, rgba(59, 130, 246, 0.05) 100%);">
  <div class="card-body">
    ...
    <p style="font-size: 1.1rem; margin-bottom: 1.5rem;">
      For a complete academic and professional overview, including detailed research descriptions and full publication list.
    </p>
    <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
      <a href="mailto:lif02501@gmail.com" class="btn btn-modern btn-ai">
        <i class="fas fa-envelope"></i> Request PDF
      </a>
...
<!-- Additional detailed sections commented out for brevity -->
